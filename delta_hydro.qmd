...
Current conditions at Freeport and Vernalis indicate that delta hydrology falls within the `r paste0("'",hydrology, "'")` category (see appendix for hydrology bin definitions). `r zoi_text`
...
map_file <- grep(hydrology, mapList, value = TRUE)
