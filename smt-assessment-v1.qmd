...
#need to add SJJ temp to cutoff
```
...
if (larval_ent_status != "relevant") {
  ...
  cat(glue("
**Threshold**: After the onset of spawning, if JPF < 0 cfs AND turbidity is ≥ 12 FNU in the south Delta AND PTM modeling indicates the action would avoid ≥ 5% entrainment of Delta smelt population after 30 days
...
1. After the start of entrainment management, is JPF < 0 and is daily average turbidity ≥ 12 FNU in the OMR corridor (stations OBI, HOL, and OSJ)?

    `r ds_eval_1`

2. Has the average water temperature at Jersey Point or Rio Vista not exceeded 53.6°F (12°C) for 3 consecutive days and/or has this action already been taken during WY 2026?
...
4. After the onset of spawning, have the following conditions occurred: JPF < 0, daily average turbidity is ≥12FNU in the South Delta, and PTM modeling indicates OMRI no more negative than -3500 cfs for at least 7 days would avoid ≥5% entrainment of the Delta smelt population at facilities after 30 days?
