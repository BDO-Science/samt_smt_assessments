...
#| fig-alt: "Map of the Delta with colored contours indicating extent of hydrodynamic footprint at different OMRI scenarios; figure on the left shows results for current flow conditions, and figure on the right shows results for forecasted flow conditions"
...
- **Daily average JPF**: {paste(JPF_1d, collapse = ', ')} cfs as of {format(JPF_1d_lastdate, '%b %d, %Y')}
...
- **Threshold:** JPF < 0 cfs, annual loss is on a trajectory to exceed 5% of the adult population abundance, and reduced exports will reduce entrainment in the south Delta
  - Daily average JPF: `r round(JPF_1d)` cfs as of `r format(JPF_1d_lastdate, "%b %d, %Y")`
