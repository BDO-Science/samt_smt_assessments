...
- **JPF**: {paste(sprintf('%.2f', JPF_7d), collapse = ', ')} cfs as of {format(JPF_last_date, '%b %d, %Y')}
...
- Threshold: JPF < 0 cfs AND salvage of adult longfin exceeds 26.8 fish (5% of FMWT Index + 1)
  - 7-day average JPF: `r sprintf("%.2f", JPF_7d)` cfs as of `r format(JPF_last_date, "%b %d, %Y")`
