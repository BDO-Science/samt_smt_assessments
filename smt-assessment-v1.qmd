...
if (adult_ent_status != "relevant") {
  ...
  cat(glue("
**Threshold**: If JPF < 0 AND turbidity ≥ 12 FNU at OBI, HOL and OSJ

- **JPF**: {paste(round(JPF_7d)), collapse = ', ')} cfs as of {format(JPF_last_date, '%b %d, %Y')}
...
- **Longfin Smelt count:** `r lfs_adults_count_wy` adult Longfin Smelt and `r lfs_juveniles_count_wy` juvenile Longfin smelt have been detected this water year. See @tbl-lfs-recent-catch for recent detections, @fig-lfs-map for spatial distribution, and @fig-lfs-catch for temporal distribution.
...
- Threshold: JPF < 0 cfs AND salvage of adult longfin exceeds 26.8 fish (5% of FMWT Index + 1)
  - 7-day average JPF: `r round(JPF_7d)` cfs as of `r format(JPF_last_date, "%b %d, %Y")`
